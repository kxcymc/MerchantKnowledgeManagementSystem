const i18n = {
  'en-US': {
    ...
    'menu.knowledgeCreation': 'Knowledge Creation',
    'menu.knowledgeManagement': 'Knowledge Management',
    'menu.knowledgeManagement.all': 'All',
    'menu.knowledgeManagement.businessGrowth': 'Business Growth',
    'menu.knowledgeManagement.onboarding': 'Merchant Onboarding',
    'menu.knowledgeManagement.fundSettlement': 'Fund Settlement',
    'menu.chatbot': 'Q&A Chatbot',
